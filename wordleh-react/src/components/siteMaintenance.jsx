        ...
        return (
            <div className="col pt-4 ms-5">
                ...
                <p className="pt-1 text-muted" style={{ textAlign: "justify" }}>
                    The site is currently down for further awesome augmentations
                    and insanely cool implementations. It's totally not because
                    of financial reasons...those are fake news.
                </p>
                <br />
                <br />
                <br />
